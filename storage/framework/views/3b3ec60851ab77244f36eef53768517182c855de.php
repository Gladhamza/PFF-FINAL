...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('conges.update', ['conge' => $conges->id])); ?>" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="employee_number" name="employee_number"
                                   value="<?php echo e($conges->employee_number); ?>"  required>
                            </div>
                            <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="date" id="reprise_date" name="reprise_date" class="form-control fc-datepicker" placeholder="YYYY-MM-DD"
                                        type="text" value="<?php echo e($conges->reprise_date); ?>" required>
                                </div>
    <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" value="<?php echo e($conges->note); ?>"rows="3"></textarea>
                            </div>
                        </div><br>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\www\GESTION pff\resources\views/conges/edit_conge.blade.php ENDPATH**/ ?>