				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							...
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/logowhite-ipd.png')); ?>" class="dark-logo-1" alt="logo"></a>
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/favicon-ipd.png')); ?>" class="logo-2" alt="logo"></a>
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/favicon-ipd.png')); ?>" class="dark-logo-2" alt="logo"></a>
						</div>
							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="<?php echo e(URL::asset('assets/img/flags/french_flag.jpg')); ?>" alt="img"></span>
										<div class="my-auto">
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="#" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="<?php echo e(URL::asset('assets/img/flags/us_flag.jpg')); ?>" alt="img"></span>
											<div class="d-flex">
									...
									<div id="unreadNotifications">
										<?php $__currentLoopData = auth()->user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<div class="main-notification-list Notification-scroll">
												...
												href="<?php echo e(url('CongesDetails')); ?>/<?php echo e($notification->data['id']); ?>">
													...
													<div class="mr-3">
														<h5 class="notification-label mb-1"><?php echo e($notification->data['Title']); ?>
															...
															<?php echo e($notification->data['use']); ?>
...
<!-- /main-header -->
<?php /**PATH C:\Users\h.ayari\backup Corporate Rh 12_02_2023 TO SEND\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>