                    ...
                    <form action="" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="result_label" name="result_label" readonly>

                            </div>

                            <div class="col">
                                <label for="result_label" class="control-label">solde de congé </label>
                                <input type="number" class="form-control" id="paid_days" name="paid_days" >
...
<script>
    $(document).ready(function() {
        ...
        $('#start_date, #end_date, #paid_days').change(calculateDays);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\www\invoice1\resources\views/conges/add_conge.blade.php ENDPATH**/ ?>