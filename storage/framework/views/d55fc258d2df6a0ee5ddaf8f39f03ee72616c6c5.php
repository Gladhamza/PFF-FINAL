											...
											<div class="border p-3">
												<div class="row">
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded" src="<?php echo e(URL::asset('assets/img/photos/8.jpg')); ?>" alt="banner image">
													</div>
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded" src="<?php echo e(URL::asset('assets/img/photos/10.jpg')); ?>" alt="banner image ">
													</div>
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded" src="<?php echo e(URL::asset('assets/img/photos/11.jpg')); ?>" alt="banner image ">
													</div>
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded " src="<?php echo e(URL::asset('assets/img/photos/12.jpg')); ?>" alt="banner image ">
													</div>
												</div>
											</div>
										</div>
...
<script src="<?php echo e(URL::asset('assets/js/accordion.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\www\invoice1\resources\views/accordion.blade.php ENDPATH**/ ?>