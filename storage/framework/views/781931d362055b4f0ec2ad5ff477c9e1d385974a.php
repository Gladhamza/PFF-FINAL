...
Modifiez liste des demandes congés
...
<?php $__env->startSection('page-header'); ?>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto ">Paramètres de gestion</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Ajout Services</span>
						</div>
					</div>
		 ...
		 <div class="modal-body">
			 ...
			 <form action="leaves/update" method="post" autocomplete="off">
				 ...
				 <div class="form-group">
					 ...
					 <label for="recipient-name" class="col-form-label">Titre Section :</label>
...
<div class="modal" id="modaldemo9">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content modal-content-demo">
			<div class="modal-header">
				<h6 class="modal-title"> Supprimer section</h6><button aria-label="Close" class="close" data-dismiss="modal"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\www\invoice1\resources\views/leaves/leaves.blade.php ENDPATH**/ ?>